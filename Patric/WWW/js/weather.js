...
function displayWeather(xmlOBJ) {
    ...
    myH1.textContent = "Temperature in " + xmlOBJ.getElementsByTagName("name")[0].childNodes[0].nodeValue + " is " + xmlOBJ.getElementsByTagName("temp_c")[0].childNodes[0].nodeValue + " C";
